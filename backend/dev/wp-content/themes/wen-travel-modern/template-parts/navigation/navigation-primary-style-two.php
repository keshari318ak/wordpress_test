		...
		<div id="primary-menu-wrapper" class="menu-wrapper show-in-desktop">
			<div class="menu-toggle-wrapper">
				<button id="menu-toggle" class="menu-toggle" aria-controls="top-menu" aria-expanded="false">
					<span class="menu-label"><?php echo esc_html_e( 'Menu', 'wen-travel-modern' ); ?></span></button>
			...
			<div class="menu-inside-wrapper">
				...
				<?php if ( has_nav_menu( 'menu-1' ) ) : ?>
					...
					<nav id="site-navigation" class="main-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Primary Menu', 'wen-travel-modern' ); ?>">
						<?php
							wp_nav_menu( array(
									'container'      => '',
				...
				<?php else : ?>
					...
					<nav id="site-navigation" class="main-navigation default-page-menu" role="navigation" aria-label="<?php esc_attr_e( 'Primary Menu', 'wen-travel-modern' ); ?>">
						<?php wp_page_menu(
							array(
		...
		<div id="primary-search-wrapper" class="menu-wrapper show-in-desktop">
			<div class="menu-toggle-wrapper">
				<button id="social-search-toggle" class="menu-toggle search-toggle">
					...
					<span class="menu-label screen-reader-text"><?php echo esc_html_e( 'Search', 'wen-travel-modern' ); ?></span>
				</button>
			</div><!-- .menu-toggle-wrapper -->
		...
		<div id="social-menu-wrapper" class="menu-wrapper show-in-mobile">
			<div class="menu-toggle-wrapper">
				<button id="share-toggle" class=" menu-toggle toggle-top share-toggle">
					<?php echo wen_travel_get_svg( array( 'icon' => 'share' ) ); echo wen_travel_get_svg( array( 'icon' => 'close' ) ); ?><span class="share-label screen-reader-text"><?php esc_html_e( 'Social Menu', 'wen-travel-modern' ); ?></span></button>
			</div><!-- .menu-toggle-wrapper -->
		...
		<div id="primary-menu-wrapper" class="menu-wrapper show-in-mobile">
			<div class="menu-toggle-wrapper">
				<button id="menu-toggle-mobile" class="menu-toggle" aria-controls="top-menu" aria-expanded="false">
					<?php echo wen_travel_get_svg( array( 'icon' => 'bars' ) ); echo wen_travel_get_svg( array( 'icon' => 'close' ) ); ?><span class="menu-label"><?php echo esc_html_e( 'Menu', 'wen-travel-modern' ); ?></span></button>
			</div><!-- .menu-toggle-wrapper -->
