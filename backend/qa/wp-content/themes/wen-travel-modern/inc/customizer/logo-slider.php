...
function wen_travel_logo_slider_options( $wp_customize ) {
	$wp_customize->add_section( 'wen_travel_logo_slider', array(
			...
			'title' => esc_html__( 'Logo Slider', 'wen-travel-modern' ),
		)
	);
	...
	wen_travel_register_option( $wp_customize, array(
			...
			'label'             => esc_html__( 'Subtitle', 'wen-travel-modern' ),
			'section'           => 'wen_travel_logo_slider',
			'type'              => 'text',
		)
	);
	...
	wen_travel_register_option( $wp_customize, array(
			...
			'sanitize_callback' => 'wp_kses_post',
			'active_callback'   => 'wen_travel_is_logo_slider_active',
			'label'             => esc_html__( 'Title', 'wen-travel-modern' ),
			'section'           => 'wen_travel_logo_slider',
			'type'              => 'text',
		)
	);
	...
	wen_travel_register_option( $wp_customize, array(
			...
			'sanitize_callback' => 'wp_kses_post',
			'active_callback'   => 'wen_travel_is_logo_slider_active',
			'label'             => esc_html__( 'Description', 'wen-travel-modern' ),
			'section'           => 'wen_travel_logo_slider',
			'type'              => 'textarea',
		)
	);
	...
	wen_travel_register_option( $wp_customize, array(
			...
			'active_callback'   => 'wen_travel_is_logo_slider_active',
			'description'       => esc_html__( 'Save and refresh the page if No. of Items is changed (Max no of slides is 20)', 'wen-travel-modern' ),
			'input_attrs'       => array(
				'style' => 'width: 100px;',
				'min'   => 0,
				'max'   => 20,
			...
			'label'             => esc_html__( 'No of Items', 'wen-travel-modern' ),
			'section'           => 'wen_travel_logo_slider',
			'type'              => 'number',
		)
	);
	...
	for ( $i = 1; $i <= $logo_slider_number ; $i++ ) {
		...
		wen_travel_register_option( $wp_customize, array(
				...
				'active_callback'   => 'wen_travel_is_logo_slider_active',
				'label'             => esc_html__( 'Page', 'wen-travel-modern' ) . ' # ' . $i,
				'section'           => 'wen_travel_logo_slider',
				'type'              => 'dropdown-pages',
			)
		);
